...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-10rem)] flex flex-col items-center text-center px-4 pb-6 pt-2">
      ...
      <p className="text-muted-foreground text-sm sm:text-base leading-relaxed max-w-[600px] mx-auto mt-6 px-2">
        Our purpose is to lift the administrative burden of sacrament
        planning&mdash;managing speakers, topics, and assignments through
