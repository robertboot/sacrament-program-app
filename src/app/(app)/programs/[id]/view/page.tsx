...
export default async function ViewProgramPage({
    ...
    supabase
      ...
      .select(
        `id, meeting_date, presiding, welcome_text, brief_reminders, invocation, benediction,
         ...
         baby_blessing, stake_business, chorister, organist, status, share_token,
  ...
  const data: ProgramRenderData = {
    ...
    openingHymnText: (program as { opening_hymn_text?: string | null }).opening_hymn_text ?? null,
    ...
    sacramentHymnText: (program as { sacrament_hymn_text?: string | null }).sacrament_hymn_text ?? null,
    ...
    closingHymnText: (program as { closing_hymn_text?: string | null }).closing_hymn_text ?? null,
